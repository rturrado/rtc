...
namespace rtc::filesystem {
    ...
    inline bool are_filesystem_trees_equal(const fs::path& path_1, const fs::path& path_2) {
        if (not fs::exists(path_1)) { throw file_path_does_not_exist_error{ path_1.generic_string() }; }
        if (not fs::exists(path_2)) { throw file_path_does_not_exist_error{ path_2.generic_string() }; }
